...
TEST(command_line_parser_parse, argc_equals_5_and_valid_argv) {
    int argc{ 5 };
...
TEST(command_line_parser_parse, argc_equals_5_and_valid_argv_in_reverse_order) {
    int argc{ 5 };
